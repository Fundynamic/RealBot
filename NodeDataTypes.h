...
#define MAX_NEIGHBOURS   16 // Maybe reduce it to 6 ot 8 as 16 is maybe too much [APG]RoboCop[CL]
#define NODE_ZONE        96 // Maybe increase it to 128 or 144 to reduce the amount of excess nodes [APG]RoboCop[CL]
